...
ADD https://api.github.com/repos/nguyenlamnghia/client-bro/git/refs/tags/test /tmp/client_version.json
RUN git clone -b test --single-branch --depth 1 https://github.com/nguyenlamnghia/client-bro client-bro
