...
ADD https://api.github.com/repos/nguyenlamnghia/client-bro/git/refs/tags/scenario_4 /tmp/client_version.json
RUN git clone -b scenario_4 --single-branch --depth 1 https://github.com/nguyenlamnghia/client-bro client-bro
