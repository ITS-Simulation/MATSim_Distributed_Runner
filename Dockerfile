...
ADD https://api.github.com/repos/nguyenlamnghia/client-bro/git/refs/tags/scenario_5 /tmp/client_version.json
RUN git clone -b scenario_5 --single-branch --depth 1 https://github.com/nguyenlamnghia/client-bro client-bro
...
ARG VERSION=v2.10.4
ARG ZIP=dist-2.10.4.zip
ARG SHA256=9093cbc15bfe58034ca9b13cade1b0eaae465a8cd468cc383f951c173e584aea
